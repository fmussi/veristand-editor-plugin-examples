...
namespace NationalInstruments.VeriStand.CustomControlsExamples
{
    ...
    public class exCustomControlModelExporter : ICustomVeriStandControl
    {
        /// <summary>
        ...
        public string Target =>
            "<pf:MergeScript xmlns:pf=\"http://www.ni.com/PlatformFramework\">" +
                "<pf:MergeItem>" +
                    "<exCustom xmlns=\"http://www.your-company.com/VeriStandExample\" Width=\"[float]172\" Height=\"[float]172\"/>" +
                "</pf:MergeItem>" +
            "</pf:MergeScript>";
        ...
        /// </summary>
        public string Name => "Custom Control";
        ...
        /// </summary>
        public string ToolTip => "Custom Control. This is the Tool Tip";
        ...
        /// </summary>
        public string UniqueId => "exCustom";
    ...
    public class exCustomControlModel : ChannelSpeedometerModel
    {
        ...
        /// </summary>
        private const string exCustomControlName = "exCustom";

        /// <summary>
        /// How this model will be represented in XML.
        /// </summary>
        public override XName XmlElementName => XName.Get(exCustomControlName, PluginNamespaceSchema.ParsableNamespaceName);

        /// <summary>Creates a <see cref="exCustomControlModel"/>.</summary>
        /// <param name="info">An <see cref="IElementCreateInfo"/> instance.</param>
        /// <returns>A <see cref="exCustomControlModel"/>.</returns>
        [XmlParserFactoryMethod(exCustomControlName, PluginNamespaceSchema.ParsableNamespaceName)]
        public static exCustomControlModel CreateShifterControlModel(IElementCreateInfo info)
        {
            var model = new exCustomControlModel();
#if MUTATE2020
