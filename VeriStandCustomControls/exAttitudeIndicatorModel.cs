...
namespace NationalInstruments.VeriStand.CustomControlsExamples
{
    ...
    /// </summary>
    public class exAttitudeIndicatorModel :
        VisualModel,
#if MUTATE2020R4
...
#endif
    {
        ...
        /// </summary>
        private const string NumericTextName = "exAttitudeIndicator";
        ...
        {
            get { return new exAttitudeIndicatorModelXamlHelper(); }
        }
        ...
        public static exAttitudeIndicatorModel Create(IElementCreateInfo info)
        {
        ...
        /// </summary>
        private class exAttitudeIndicatorModelXamlHelper : XamlGenerationHelper
        {
            public override Type ControlType => typeof(exAttitudeIndicator);
        }
        ...
        public async Task OnConnectedAsync()
        {
            ...
            Host.BeginInvoke(AsyncTaskPriority.WorkerHigh, () =>
                {
                    MessageScope?.AllMessages.ClearMessageByCategoryAndReportingElement(exAttitudeIndicatorModelErrorString, this);
                });
        ...
        private void ReportErrorToModel(Exception ex)
        {
            ...
            Host.BeginInvoke(AsyncTaskPriority.WorkerHigh, () =>
            {
                MessageScope?.AllMessages.ClearMessageByCategoryAndReportingElement(
                    exAttitudeIndicatorModelErrorString,
                    this);
#if MUTATE2021
                this.SafeReportError(PwmControlModelErrorString, null, MessageDescriptor.Empty, ex);
#else
                this.ReportError(exAttitudeIndicatorModelErrorString, null, MessageDescriptor.Empty, ex);
#endif
            });
        }
        ...
        private bool CheckForVectorChannels(string channelName)
        {
            ...
            {
                ReportError(exAttitudeIndicatorModelErrorString, null, MessageDescriptor.Empty, "Cannot Register Vector Channels");
                return true;
            }
            return false;
        }
