...
namespace NationalInstruments.VeriStand.CustomControlsExamples
{
    ...
    /// </summary>
    public class exAttitudeIndicatorViewModel : VisualViewModel, IControlContextMenuHelper
    {
        /// <summary>
        ...
        {
            var attIndicator = View.Children.FirstOrDefault().AsFrameworkElement as exAttitudeIndicator;
            if (attIndicator != null)
            {
                //attIndicator.
...
*/
        ...
        public override void ModelPropertyChanged(Element modelElement, string propertyName, TransactionItem transactionItem)
        {
            ...
            ((exAttitudeIndicatorModel)Model).PropertyChanged(modelElement, propertyName, transactionItem);
        }
        ...
        public static readonly ISelectionCommand FrequencyChannelBrowseCommand = new ShellSelectionRelayCommand(LaunchDutyCycleChannelBrowser, CanLaunchChannelBrowser)
        {
            ...
            LargeImageSource = ResourceHelpers.LoadImage(typeof(exAttitudeIndicatorViewModel), "Resources/Browse.png"),
            SmallImageSource = ResourceHelpers.LoadImage(typeof(exAttitudeIndicatorViewModel), "Resources/Browse_16x16.png"),
        ...
        {
            return selection.All(s => s.Model is exAttitudeIndicatorModel);
        }
        ...
        private static void LaunchChannelBrowser(ICommandParameter parameter, IEnumerable<IViewModel> selection, ICompositionHost host, DocumentEditSite site)
        {
            ...
            _uiSdfBrowsePopup.Channel = _settingFrequency ? ((exAttitudeIndicatorModel)_currentSelection.First().Model).FrequencyChannel : ((exAttitudeIndicatorModel)_currentSelection.First().Model).DutyCycleChannel;
        ...
        private static void SelectChannels(ICommandParameter parameter, IEnumerable<IViewModel> selection, ICompositionHost host, DocumentEditSite site)
        {
            IEnumerable<string> frequencyChannels = selection.Select(item => item.Model)
                .OfType<exAttitudeIndicatorModel>()
        ...
        {
            ((exAttitudeIndicatorModel)Model).SetChannelValue(eventArgs.ChannelName, (double)eventArgs.ChannelValue);
        }
    }
}
