...
namespace NationalInstruments.VeriStand.CustomControlsExamples
{
    ...
    /// </summary>
    public class exCustomControlViewModel : ChannelSpeedometerViewModel
    {
        /// <summary>
        ...
        public exCustomControlViewModel(exCustomControlModel model) : base(model)
        {
        }
