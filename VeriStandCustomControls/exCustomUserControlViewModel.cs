...
namespace NationalInstruments.VeriStand.CustomControlsExamples
{
    public class exCustomUserControlViewModel : VisualViewModel, IControlContextMenuHelper
    {
        ...
        private void CustomUserControlValueChangedEventHandler(object sender, ChannelValueChangedEventArgs e)
        {
        ...
        /// <summary>
        /// Creates the view associated with this view model by initializing a new instance of our custom control class exCustomUserControl
        ...
        /// </summary>
        /// <returns>exCustomUserControl view</returns>
        public override object CreateView()
        {
            var view = new exCustomUserControl(this);
            WeakEventManager<exCustomUserControl, CustomChannelValueChangedEventArgs>.AddHandler(view, "ValueChanged", SetChannelValue);
            return view;
        }
        ...
        public override void ModelPropertyChanged(Element modelElement, string propertyName, TransactionItem transactionItem)
        {
            ...
            ((exCustomUserControlModel)Model).PropertyChanged(modelElement, propertyName, transactionItem);
        }
        ...
        {
            return selection.All(s => s.Model is exCustomUserControlModel);
        }
        ...
        {
            ((exCustomUserControlModel)Model).SetChannelValue(eventArgs.ChannelName, (double)eventArgs.ChannelValue);
        }
    }
}
